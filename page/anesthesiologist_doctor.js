...
export default class Ane_Doc extends React.Component {
        ...
        <ScrollView>
         ...
         <View style={styles.picker1}> 
            <DropDownPicker
                       items={[ 
                           // {label: 'Select', value: 'Select',  hidden: true},
                            {label: 'Grant Permission to Operate', value: 'PERMITTED' },
                            {label: 'Deny Permission to Operate', value: 'DENIED'},
            ...
            <View style={styles.buttonsback}>
              <Button
                onPress={() => navigate('Anesthesiologist_Select')}
                title="Back"
                color="#32a882"
              />
            </View>
