...
export default class  Anesthesiologist_Select extends React.Component {
 ...
 pushNext = (id) => {
  //  alert(id)
  this.props.navigation.push('Anesthesiologist_Doctor' , {id}); 
 }
 ...
 async getPatients() {
  fetch('http://192.168.1.101/CSTH_PHP/show_all_ane.php', {
    method: 'GET',
    headers: {
          ...
          <View style={styles.container}>
            ...
            {/* <View style={styles.list}>  */}
            {
              ...
              ?  this.state.names.map((item, index) => (
               ...
               :<Text style={styles.inputTexttopic}>No Pending Items Available</Text>
